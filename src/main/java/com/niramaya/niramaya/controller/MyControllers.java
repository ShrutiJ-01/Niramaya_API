...
import com.niramaya.niramaya.database.UserVerification;
//entities
...
public class MyControllers {
	...
	public Map<String, Integer> createUser(@RequestBody String requestJson) {
		...
		String deviceId = (String) jsonObject.get("device_id");

		// redirecting to creation functions
		int createStatus = this.niramayaService.addUser(username, deviceId);
	...
	public UserProgressLog updateUserProgress(@RequestBody String requestJson) {
		...
		if (UserVerification.isValidCredential(deviceid)) {
